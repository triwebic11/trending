...
const SuperAgentList = () => {
    const data = [
    { id: 8, type: 'সুপার এজেন্ট', phone: '+855969477041', site: ["BAAJIWALA", "VELKI"] },
    { id: 19, type: 'সুপার এজেন্ট', phone: '+85570550486', site: ["VELKI"] },
    { id: 7, type: 'সুপার এজেন্ট', phone: '+601124255228', site: ["BAAJIWALA"] },
    { id: 15, type: 'সুপার এজেন্ট', phone: '+85510526088', site: ["BAAJIWALA"] },
    ...
    { id: 27, type: 'সুপার এজেন্ট', phone: '+601124255228', site: ["BAAJIWALA"] },
    { id: 215, type: 'সুপার এজেন্ট', phone: '+85510526088', site: ["BAAJIWALA"] },
          ...
          <div className="">
            ...
            <div className="">
              <div className="mb-20">
                ...
                <Link to="/subadminlist" className="hover:text-[#ff7c7c]">Next: <br /> Sub Agent List</Link>
