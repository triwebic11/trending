...
import subadminimage from "../../assets/sub-admin.jpg"
...
const SubAdminList = () => {
   const data = [
    ...
    { id: 19, type: 'সাব এডমিন', phone: '+85570550486', site: ["VELKI"] },
    { id: 7, type: 'সাব এডমিন', phone: '+601124255228', site: ["BAAJIWALA"] },
    { id: 15, type: 'সাব এডমিন', phone: '+85510526088', site: ["BAAJIWALA"] },
    { id: 23, type: 'সাব এডমিন', phone: '+601124069381', site: ["VELKI"] },
    { id: 20, type: 'সাব এডমিন', phone: '+85570564732', site: ["VELKI"] },
    { id: 11, type: 'সাব এডমিন', phone: '+85561743988', site: ["VELKI"] },
    { id: 9, type: 'সাব এডমিন', phone: '+85595989258', site: ["VELKI"] },
    { id: 18, type: 'সাব এডমিন', phone: '+85581749657', site: ["VELKI"] },
    { id: 22, type: 'সাব এডমিন', phone: '+60173153172', site: ["VELKI"] },
    { id: 27, type: 'সাব এডমিন', phone: '+601124255228', site: ["BAAJIWALA"] },
    { id: 215, type: 'সাব এডমিন', phone: '+85510526088', site: ["BAAJIWALA"] },
    { id: 223, type: 'সাব এডমিন', phone: '+601124069381', site: ["VELKI"] },
    { id: 220, type: 'সাব এডমিন', phone: '+85570564732', site: ["VELKI"] },
    { id: 211, type: 'সাব এডমিন', phone: '+85561743988', site: ["VELKI"] },
    { id: 29, type: 'সাব এডমিন', phone: '+85595989258', site: ["VELKI"] },
    { id: 218, type: 'সাব এডমিন', phone: '+85581749657', site: ["VELKI"] },
    { id: 222, type: 'সাব এডমিন', phone: '+60173153172', site: ["VELKI"] },
  ];
  return (
    <div>
      <div>
                ...
                <div className="">
                  ...
                  />
                    ...
                    <div className="flex justify-between mt-4 text-xl">
                      <Link to="/superagentlist" className="hover:text-[#ff7c7c]">previous: <br /> Super Agent List</Link>
                      <Link to="/siteadminlist" className="hover:text-[#ff7c7c]">Next: <br /> Site Agent List</Link>
